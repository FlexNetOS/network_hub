...
BESPOKE_REQUIRED = ["category", "protocol"]
ENUMS = {
    "status": {"stable", "beta", "experimental", "deprecated"},
    "category": {"host", "service-endpoint", "tunnel", "proxy", "vpn", "topology"},
    "protocol": {"http", "https", "tcp", "udp", "ssh", "grpc", "ws"},
    "auth": {"none", "oauth", "api-key", "mtls", "ssh-key"},
    "reachableFrom": {"local", "lan", "public"},
}
FILE_REF_FIELDS = ["doc", "snippet"]
JSON_REF_FIELDS = []
# ──────────────────────────────────────────────────────────────────────────────
